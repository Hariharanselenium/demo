...
public class APISoftAssert {
    ...
    private String randomEmail = UUID.randomUUID().toString() + "@example.com";
    ...
    public void testPostRequest() {
        ...
        // Other test steps (if any)
        // ...
        
        // Call assertAll() at the end of the test to report all failures
    ...
    public void testPutRequest() {
        ...
        softAssert.assertEquals(putResponse.getStatusCode(), 201, "PUT request failed. Status code is not 200.");
